...
response.menu = [
	...
	(IMG(_src=URL('static','images/audio.png'), _alt='Gravações de áudio'), False, domainname+'/conteudo/audios', []),
	(IMG(_src=URL('static','images/video.png'), _alt='Material audiovisual'), False, domainname+'/conteudo/videos', []),
]
